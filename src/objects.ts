...
export function isValid(question: Question, answer: string): boolean {
    const isShortAnswer = question.type === "short_answer_question";
    const isMultipleChoice = question.type === "multiple_choice_question";
    const answerInOptions = question.options.includes(answer);

    return isShortAnswer || (isMultipleChoice && answerInOptions);
}
